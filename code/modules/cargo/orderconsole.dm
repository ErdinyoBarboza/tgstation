...
/obj/machinery/computer/cargo/ui_static_data(mob/user)
	...
	for(var/pack in SSshuttle.supply_packs)
		...
		if((P.hidden && !(obj_flags & EMAGGED)) || (P.contraband && !contraband) || (P.special && !P.special_enabled) || P.DropPodOnly || P.DepOrderOnly)
			continue
...
/obj/machinery/computer/cargo/ui_act(action, params, datum/tgui/ui)
	...
	switch(action)
		...
		if("add")
			...
			if((pack.hidden && !(obj_flags & EMAGGED)) || (pack.contraband && !contraband) || pack.DropPodOnly || (pack.special && !pack.special_enabled) || P.DepOrderOnly)
				return
